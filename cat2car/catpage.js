...
function buttonFunction(catSelection1, event) {
  ...
  switch (catSelection1) {
    case "persian":
      ...
      text.innerHTML = "*Money, money, money*";
      break;
    case "siamese":
    ...
    case "black":
      ...
      break;
    case "zelda":
      textNames.innerHTML = "Jaguar XKE";
      text.innerHTML = "because she was beautiful, elegant and timeless. Still miss you little one <3";
      break;
    default:
